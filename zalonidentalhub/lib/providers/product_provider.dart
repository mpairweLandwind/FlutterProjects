...
class ProductState {
  ...
  final Map<String, Map<String, dynamic>> category; // Updated to store category data
...
class ProductNotifier extends StateNotifier<ProductState> {
  final List<ImageProvider> _precachedImages = []; // Moved _precachedImages here
...
Future<void> fetchProducts(String? category) async {
  ...
  try {
    var querySnapshot = await FirebaseFirestore.instance
        .collection('products')
        .where('category', isEqualTo: category)  .limit(10) .get();
